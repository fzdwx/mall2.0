...
public class RedisUtil {
    ...
    /**
     ...
     @return
     */
    public Long sIntersectAndStore(
            String key, Collection<String> otherKeys,
            String destKey) {
    ...
    /**
     ...
     @return
     */
    public Set<TypedTuple<String>> zRangeWithScores(
    ...
    /**
     ...
     @return
     */
    public Set<TypedTuple<String>> zReverseRangeWithScores(
            String key,
            long start, long end) {
