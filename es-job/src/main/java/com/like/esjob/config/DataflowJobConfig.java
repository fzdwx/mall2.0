...
import com.like.esjob.task.SpringDataflowJob;
...
public class DataflowJobConfig {
    ...
    public JobScheduler dataflowJobScheduler(
            final DataflowJob dataflowJob, @Value("${dataflowJob.cron}") final String cron,
...
//    	springJobScheduler.init();
    ...
    private LiteJobConfiguration getLiteJobConfiguration(
            final Class<? extends DataflowJob> jobClass, final String cron, final int shardingTotalCount,
