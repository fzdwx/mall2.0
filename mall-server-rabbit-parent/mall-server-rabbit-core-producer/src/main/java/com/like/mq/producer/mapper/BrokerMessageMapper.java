package com.like.mq.producer.mapper;
...
public interface BrokerMessageMapper {
    ...
    void changeBrokerMessageStatus(
            @Param("brokerMessageId") String brokerMessageId, @Param("brokerMessageStatus") String brokerMessageStatus,
